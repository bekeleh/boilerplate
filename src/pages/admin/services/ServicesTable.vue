...
export default {
    ...
    methods: {
        ...
        Filter() {
            if (!this.disableSearchBtn) this.fetchService();
        },
        newService() {
            this.$router.push({ name: "admin.services.new" });
        },
        editService(id) {
            this.$router.push({
        ...
        deleteService(id) {
            this.$store.dispatch("adminService/delete", id).then((response) => {
        ...
        fetchService() {
            this.loading = true;
            this.$store
                .dispatch("adminService/fetchService", {
        ...
        onChange(url) {
            ...
            this.loading = true;
            this.$store.dispatch("adminService/paginate", query).then(
                (response) => {
                    this.services = response.data.data;
                    this.pagination.links = response.data.links;
