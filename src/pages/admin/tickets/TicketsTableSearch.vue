...
export default {
    ...
    methods: {
        ...
        Filter() {
            if (!this.disableSearchBtn) this.fetchSearchTicket();
        },
        // postComment(slug) {
        //     this.$router.push({
        //         name: "admin.search_tickets.comments",
        //         params: {
        //             slug: slug,
        //             route: "admin.tickets.search",
        ...
        fetchSearchTicket() {
            this.loading = true;
            this.$store
                .dispatch("adminTicket/fetchSearchTicket", {
