            ...
            <div class="space-y-8 divide-y divide-gray-200 lg:w-1/2">
                <div class="p-4">
                    ...
                    >
                        ...
                        <div v-if="ticket.deleted_at" class="sm:col-span-3">
                            <label
                                for="created_at"
                                class="block text-sm font-medium text-gray-700"
                            >
            ...
            <div class="pt-5 pb-3">
                <div class="flex justify-end">
                    <button
                        ...
                        @click.prevent="backToSearchPage"
                    >
                        Back
                    </button>
                </div>
...
export default {
    ...
    methods: {
        ...
        fetchTicket() {
            ...
            this.loading = true;
            this.$store.dispatch("adminTicket/SearchTicketById", params).then(
                (response) => {
                    this.loading = false;
                    if (response.data) {
        ...
        backToSearchPage() {
            this.$router.push({ name: "admin.tickets.search" });
        },
