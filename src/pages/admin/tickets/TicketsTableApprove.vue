...
export default {
    ...
    methods: {
        ...
        Filter() {
            if (!this.disableSearchBtn) this.fetchApprovalTicket();
        },
        postComment(slug) {
            this.$router.push({
        ...
        fetchApprovalTicket() {
            this.loading = true;
            this.$store
                .dispatch("adminTicket/fetchApproveTicket", {
