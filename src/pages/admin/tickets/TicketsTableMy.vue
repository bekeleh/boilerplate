<template>
    <div class="flex flex-col">
        <div class="overflow-x-auto sm:-mx-6 lg:-mx-0 my-6">
            ...
            >
                <div
                    class="items-center justify-between shadow-md overflow-hidden border border-gray-200 sm:rounded-lg"
                >
                    <!-- Sidebar Search -->
                    <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <a
                                        ...
                                        "
                                        href="#"
                                        class="text-indigo-600 mr-2 cursor-pointer hover:text-indigo-900"
                                        @click.stop="
                                            verifyTicket(ticket.tt_number)
                                        "
                                        >Edit</a
                                    >
                                </td>
...
<script>
import { SearchIcon, ChatIcon, FilterIcon } from "@heroicons/vue/outline";
...
export default {
    ...
    computed: {
        ...
        disableSearchBtn() {
            return (
                ...
                this.isNullOrEmpty(this.ticketStatus)
            );
        },
    },
    created() {
    ...
    methods: {
        ...
        Filter() {
            if (!this.disableSearchBtn) this.fetchMyTicket();
        },
        postComment(slug) {
            this.$router.push({
        ...
        fetchMyTicket() {
            this.loading = true;
            this.$store
                .dispatch("adminTicket/fetchMyTicket", {
