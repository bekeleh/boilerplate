                ...
                >
                    ...
                    >
                        <div>
                            <button
                                type="button"
                                class="order-0 inline-flex items-end m-3 pr-4 pl-3 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-et-green-light hover:bg-et-green focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-et-green sm:order-1 sm:ml-3"
                                @click="clearFilter"
                            >
                                Clear
                            </button>
                        ...
                        <div
                            class="flex-1 px-2 flex justify-center lg:ml-6 lg:justify-end"
                        >
                            <!-- Search section -->
                            <div class="max-w-lg w-full lg:max-w-xs">
                                ...
                                >
                                    ...
                                    <input
                                        id="search"
                                        class="block w-full bg-white py-2 pl-10 pr-3 border border-gray-300 rounded-md leading-5 text-gray-500 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-et-green-light focus:border-et-green-light focus:placeholder-gray-500 sm:text-sm"
                                        placeholder="Search"
                                        type="text"
                                        name="search"
                                        @keyup.enter="Filter"
                        ...
                        <tbody v-if="tickets.length">
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                    <a
                                        v-if="can('assign', 'ticket')"
                                        href="#"
                                        class="px-2 text-gray-700 hover:text-gray-900 cursor-pointer"
                                        @click.stop="
                                            dispatchTicket(ticket.tt_number)
                                        "
                                        >Assign</a
                                    >
                                </td>
...
<script>
import { SearchIcon, ChatIcon } from "@heroicons/vue/outline";
...
export default {
    ...
    methods: {
        ...
        fetchTicket() {
            this.loading = true;
            this.$store
                .dispatch("adminTicket/fetchTicket", {
        ...
        onChange(url) {
            ...
            this.loading = true;
            this.$store.dispatch("adminTicket/paginate", query).then(
                (response) => {
                    this.tickets = response.data.data;
                    this.pagination.links = response.data.links;
