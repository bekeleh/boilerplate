...
export default {
    ...
    methods: {
        ...
        Filter() {
            if (!this.disableSearchBtn) this.fetchAssignedTicket();
        },
        postComment(slug) {
            this.$router.push({
        ...
        fetchAssignedTicket() {
            this.loading = true;
            this.$store
                .dispatch("adminTicket/fetchAssignedTicket", {
        ...
        onChange(url) {
            ...
            this.loading = true;
            this.$store.dispatch("adminTicket/paginateAssigned", query).then(
                (response) => {
                    this.tickets = response.data.data;
                    this.pagination.links = response.data.links;
