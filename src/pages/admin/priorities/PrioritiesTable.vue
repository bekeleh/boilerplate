                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody v-if="priorities.length">
                            ...
                            >
                                ...
                                >
                                    <a
                                        v-if="can('view', 'priority')"
                                        href="#"
                                        class="text-indigo-600 mr-2 hover:text-indigo-900 cursor-pointer"
                                        @click.stop="viewPriority(priority.id)"
                                        >View</a
                                    >
                                    <a
                                        v-if="can('edit', 'priority')"
                                        href="#"
                                        class="text-indigo-600 mr-2 hover:text-indigo-900 cursor-pointer"
                                        @click.stop="editPriority(priority.id)"
                                        >Edit</a
                                    >
...
export default {
    ...
    methods: {
        ...
        Filter() {
            if (!this.disableSearchBtn) this.fetchPriority();
        },
        newPriority() {
            this.$router.push({
        ...
        deletePriority(id) {
            this.$store
                .dispatch("adminPriority/delete", id)
                .then((response) => {
        ...
        fetchPriority() {
            this.loading = true;
            this.$store
                .dispatch("adminPriority/fetchPriority", {
        ...
        onChange(url) {
            ...
            this.$store.dispatch("adminPriority/paginate", query).then(
                (response) => {
                    this.priorities = response.data.data;
                    this.pagination.links = response.data.links;
