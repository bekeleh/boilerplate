...
export default {
    ...
    methods: {
        fetchUser(id) {
            this.$store.dispatch("adminAccount/fetchAccountById", id).then(
                (response) => {
                    this.user = response.data.data;
                    this.selectedManagers = this.user.managers;
