            ...
            >
                ...
                >
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody v-if="requisitions.length">
                            <tr
                                v-for="(
...
export default {
    ...
    methods: {
        ...
        newRequisition() {
            this.$router.push({ name: "admin.requisitions.new" });
        },
        editRequisition(id) {
            this.$router.push({
        ...
        deleteRequisition(id) {
            this.$store
                .dispatch("adminRequisition/delete", id)
                .then((response) => {
        ...
        fetchRequisition() {
            this.loading = true;
            this.$store
                .dispatch("adminRequisition/fetchRequisition", {
        ...
        onChange(url) {
            ...
            this.loading = true;
            this.$store.dispatch("adminRequisition/paginate", query).then(
                (response) => {
                    this.requisitions = response.data.data;
                    this.pagination.links = response.data.links;
