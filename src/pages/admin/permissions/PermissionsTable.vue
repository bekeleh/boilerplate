...
export default {
    ...
    methods: {
        ...
        Filter() {
            if (!this.disableSearchBtn) this.fetchPermission();
        },
        newPermission() {
            this.$router.push({ name: "admin.permissions.new" });
        },
        editPermission(id) {
            this.$router.push({
        ...
        deletePermission(id) {
            this.$store
                .dispatch("adminPermission/delete", id)
                .then((response) => {
        ...
        fetchPermission() {
            this.loading = true;
            this.$store
                .dispatch("adminPermission/fetchPermission", {
        ...
        onChange(url) {
            ...
            this.$store.dispatch("adminPermission/paginate", query).then(
                (response) => {
                    this.permissions = response.data.data;
                    this.pagination.links = response.data.links;
