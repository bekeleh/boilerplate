            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div
                                v-if="can('create', 'requisition-requirement')"
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody v-if="requisitionRequirements.length">
                            <tr
                                v-for="(
                                    requisition, requisitionIdx
                                ) in requisitionRequirements"
                                :key="requisitionIdx"
                                :class="
                                    requisitionIdx % 2 === 0
                                        ? 'bg-white'
                            ...
                            >
                                ...
                                >
                                    <a
                                        ...
                                        @click.stop="
                                            viewRequisition(requisition.id)
                                        "
                                        >View</a
                                    >
                                    <a
                                        ...
                                        class="text-indigo-600 mr-2 hover:text-indigo-900 cursor-pointer"
                                        @click.stop="
                                            editRequisition(requisition.id)
                                        "
                                        >Edit</a
                                    >
...
export default {
    ...
    methods: {
        ...
        Filter() {
            if (!this.disableSearchBtn) this.fetchRequisition();
        },
        newRequisition() {
            this.$router.push({ name: "admin.requisition-requirements.new" });
        },
        editRequisition(id) {
            this.$router.push({
        ...
        deleteRequisition(id) {
            this.$store
                .dispatch("adminRequisitionRequirement/delete", id)
                .then((response) => {
        ...
        fetchRequisition() {
            ...
            this.$store
                .dispatch(
                    "adminRequisitionRequirement/fetchRequisitionRequirement",
                    {
                ...
                .then(
                    (response) => {
                        this.loading = false;
                        if (response.data) {
                            this.requisitionRequirements = response.data.data;
        ...
        onChange(url) {
            ...
            this.loading = true;
            this.$store
                .dispatch("adminRequisitionRequirement/paginate", query)
                .then(
                    (response) => {
                        this.requisitionRequirements = response.data.data;
                        this.pagination.links = response.data.links;
