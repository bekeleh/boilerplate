            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <!-- <div
                                ...
                                class="mt-4 p-3 md:flex sm:mt-0 sm:ml-4"
                            >
                                <button
                                    type="button"
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody v-if="activity_logs.length">
                            <tr
                                v-for="(
                                    activity_log, activity_logIdx
                                ) in activity_logs"
                                :key="activity_logIdx"
                                :class="
                                    activity_logIdx % 2 === 0
                            ...
                            >
                                ...
                                >
                                    {{
                                        ...
                                        activity_log.properties.length > 50
                                            ? activity_log.properties.substring(
                                                  0,
                                                  50
                                              ) + "..."
                                            : activity_log.properties
                                ...
                                >
                                    {{
                                        ...
                                        activity_log.description.length > 50
                                            ? activity_log.description.substring(
                                                  0,
                                                  50
                                              ) + "..."
                                            : activity_log.description
...
export default {
    ...
    methods: {
        ...
        Filter() {
            if (!this.disableSearchBtn) this.fetchActivitylog();
        },
        newActivitylog() {
            this.$router.push({
                name: "admin.activity_logs.new",
            });
        },
        editActivitylog(id) {
            this.$router.push({
                name: "admin.activity_logs.edit",
                params: { id: id },
            });
        },
        viewActivitylog(id) {
        ...
        deleteActivitylog(id) {
            this.$store
                .dispatch("adminActivitylog/delete", id)
                .then((response) => {
        ...
        fetchActivitylog() {
            this.loading = true;
            this.$store
                .dispatch("adminActivitylog/fetchActivitylog", {
        ...
        onChange(url) {
            ...
            this.$store.dispatch("adminActivitylog/paginate", query).then(
                (response) => {
                    this.activity_logs = response.data.data;
                    this.pagination.links = response.data.links;
