            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div class="mt-4 p-3 flex sm:mt-0 sm:ml-4">
                                <button
                                    type="button"
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody v-if="statuses.length">
                            ...
                            >
                                ...
                                >
                                    <a
                                        v-if="can('view', 'status')"
                                        href="#"
                                        class="text-indigo-600 mr-2 hover:text-indigo-900 cursor-pointer"
                                        @click.stop="viewStatus(status.id)"
                                        >View</a
                                    >
                                    <a
                                        v-if="can('edit', 'status')"
                                        href="#"
                                        class="text-indigo-600 mr-2 hover:text-indigo-900 cursor-pointer"
                                        @click.stop="editStatus(status.id)"
                                        >Edit</a
                                    >
                                    <a
                                        ...
                                        class="text-indigo-600 mr-2 hover:text-indigo-900 cursor-pointer"
                                        @click.stop="deleteStatus(status.id)"
                                    >
                                        Delete
                                    </a>
                                </td>
...
export default {
    ...
    methods: {
        ...
        Filter() {
            if (!this.disableSearchBtn) this.fetchStatus();
        },
        newStatus() {
            this.$router.push({
        ...
        deleteStatus(id) {
            this.$store.dispatch("adminStatus/delete", id).then((response) => {
        ...
        fetchStatus() {
            this.loading = true;
            this.$store
                .dispatch("adminStatus/fetchStatus", {
        ...
        onChange(url) {
            ...
            this.$store.dispatch("adminStatus/paginate", query).then(
                (response) => {
                    this.statuses = response.data.data;
                    this.pagination.links = response.data.links;
