                ...
                >
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody v-if="clients.length">
                            <tr
                                v-for="(client, clientIdx) in clients"
                                :key="clientIdx"
                                :class="
                                    clientIdx % 2 === 0
                                        ? 'bg-white'
                            ...
                            >
                                ...
                                >
                                    {{ fromNow(client.last_logged_in_at) }}
                                </td>
                                <td
                                    class="px-3 py-2 whitespace-nowrap text-sm text-gray-500"
                                >
...
export default {
    ...
    methods: {
        ...
        fetchClient() {
            this.loading = true;
            this.$store
                .dispatch("adminClient/fetchClient", {
        ...
        onChange(url) {
            ...
            this.loading = true;
            this.$store.dispatch("adminClient/paginate", query).then(
                (response) => {
                    this.clients = response.data.data;
                    this.pagination.links = response.data.links;
        ...
        deleteClient(id) {
            this.$store.dispatch("adminClient/delete", id).then((response) => {
