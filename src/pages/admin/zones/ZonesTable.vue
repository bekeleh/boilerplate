...
export default {
    ...
    methods: {
        ...
        Filter() {
            if (!this.disableSearchBtn) this.fetchZone();
        },
        newZone() {
            this.$router.push({ name: "admin.zones.new" });
        },
        editZone(id) {
            this.$router.push({
        ...
        deleteZone(id) {
            this.$store.dispatch("adminZone/delete", id).then((response) => {
        ...
        onChange(url) {
            ...
            this.loading = true;
            this.$store.dispatch("adminZone/paginate", query).then(
                (response) => {
                    this.zones = response.data.data;
                    this.pagination.links = response.data.links;
