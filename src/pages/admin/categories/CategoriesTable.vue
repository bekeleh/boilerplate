                            ...
                            >
                                ...
                                >
                                    <a
                                        ...
                                        @click.stop="viewCategory(category.id)"
                                        >View</a
                                    >
                                    <a
...
export default {
    ...
    methods: {
        ...
        Filter() {
            if (!this.disableSearchBtn) this.fetchCategory();
        },
        newCategory() {
            this.$router.push({
        ...
        deleteCategory(id) {
            this.$store
                .dispatch("adminCategory/delete", id)
                .then((response) => {
        ...
        fetchCategory() {
            this.loading = true;
            this.$store
                .dispatch("adminCategory/fetchCategory", {
        ...
        onChange(url) {
            ...
            this.$store.dispatch("adminCategory/paginate", query).then(
                (response) => {
                    this.categories = response.data.data;
                    this.pagination.links = response.data.links;
