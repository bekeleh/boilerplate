...
const END_POINT = "admin/service_approvers/";

class AdminServiceApproverService {
    paginate(data) {
        return http.get(
    ...
    fetchServiceApproverById(service) {
...
export default new AdminServiceApproverService();
